...
String[] winMessages = {"+WHAT+HOW+HACKING", "SHEESH ur cracked", "very niiice", "nice balls 8.5/10", "nice cock, uhhh 7.5/10", "LETS GOOOOO CLUTCH"};
String reasonForShake;//"Not enough letters" or "Not in word list"
boolean gameDone = false;
final float gameSize = 1;//compared to 1000, 1300
void setup(){
  currentSpace[0] = 0;
  currentSpace[1] = 0;
  size(1000,1300);//1000, 1300 at gameSize = 1
  frameRate(30);
